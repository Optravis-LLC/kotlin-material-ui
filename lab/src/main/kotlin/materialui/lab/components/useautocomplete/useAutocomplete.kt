...
external interface UseAutocompleteProps<T>: Props {
...
external interface UseAutocompleteInterface<T> {
    fun getRootProps(): Props
    fun getInputProps(): Props
    fun getInputLabelProps(): Props
    fun getClearProps(): Props
    fun getPopupIndicatorProps(): Props
    fun getTagProps(params: GetTagPropsParams): Props
    fun getListboxProps(): Props
    fun getOptionProps(params: GetOptionPropsParams<T>): Props
    val id: String
