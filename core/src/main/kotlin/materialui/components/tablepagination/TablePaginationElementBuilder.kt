...
class TablePaginationElementBuilder<T: Tag> internal constructor(
    ...
    var Tag.backIconButtonProps: Props? by materialProps
    ...
    var Tag.nextIconButtonProps: Props? by materialProps
    ...
    fun <P: Props, C: Component<P, *>> Tag.actionsComponent(kClass: KClass<C>) {
    ...
    fun Tag.backIconButtonProps(block: IconButtonElementBuilder<BUTTON>.() -> Unit) {
        backIconButtonProps = buildElement { iconButton(block = block) }.props
    }
    fun <T2: Tag> Tag.backIconButtonProps(factory: (TagConsumer<Unit>) -> T2, block: IconButtonElementBuilder<T2>.() -> Unit) {
        backIconButtonProps = buildElement { iconButton(factory = factory, block = block) }.props
    }
    ...
    fun Tag.nextIconButtonProps(block: IconButtonElementBuilder<BUTTON>.() -> Unit) {
        nextIconButtonProps = buildElement { iconButton(block = block) }.props
    }
    fun <T2: Tag> Tag.nextIconButtonProps(factory: (TagConsumer<Unit>) -> T2, block: IconButtonElementBuilder<T2>.() -> Unit) {
        nextIconButtonProps = buildElement { iconButton(factory = factory, block = block) }.props
    }
